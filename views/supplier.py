...
def save_supplier(name, contact, email, address, tree):
...
# Delete Supplier
# ------------------------------------------------
def delete_supplier(selected_id, tree):
...
def open_window():
    ...
    Button(
        ...
        text="Search",
        width=12,
        command=lambda: search_supplier(
            search,
            tree
        )
    ...
    Button(
        ...
        text="Show All",
        width=12,
        command=lambda: show_suppliers(tree)
    ).grid(row=0, column=3)
    # ================================================
    # Supplier Details Frame
    # ================================================
    supplier_frame = LabelFrame(
    win,
    ...
    # ======================================================
    # Fields inside Supplier Details Frame
    # =======================================================
...
# ==========================
    ...
    # ---This code part of Select Supplier----
    tree.bind(
    "<<TreeviewSelect>>",
