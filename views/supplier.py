...
# =====================================
def select_supplier(event, tree, name, contact, email, address, selected_id):
...
def handle_save(name, contact, email, address, tree):
    if save_supplier(name, contact, email, address):
...
def handle_update(selected_id, name, contact, email, address, tree):
    if update_supplier(selected_id, name, contact, email, address):
        refresh_suppliers(tree)
        selected_id.set("")
        name.set("")
        contact.set("")
...
def open_window():
    ...
    Button(
        ...
        command=lambda: open_supplier_purchase_history(selected_id, name)
    ...
    tree.bind(
        "<<TreeviewSelect>>",
        lambda event: select_supplier(event, tree, name, contact, email, address, selected_id)
    )
...
def open_supplier_purchase_history(selected_id, name):
    ...
    size_and_center(win, width_ratio=0.8, height_ratio=0.75, resizable=True)
